function AStar(gridMatrix, startPos, endPos, heuristicType, weight, allowDiagonal, biDirectional) {
    let heuristic = null;
    ...
    return genericAStar(gridMatrix, startPos, endPos, heuristic, weight, allowDiagonal, biDirectional);
}
